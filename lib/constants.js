...
// Per-item shadow resistance (itemId → SR). Verified from Wowhead TBC tooltips.
// Seeded from items seen in live logs; extend as new SR gear appears. Most gear
// grants 0 SR — the dominant source is the Shadow Protection buff above.
export const SHADOW_RESIST_ITEMS = {
  29400: 14,  // Abyssal Shroud
  32396: 13,  // Redeemed Soul Legguards
  32392: 7,   // Soulguard Bracers
  32395: 7,   // Redeemed Soul Wristguards
  32420: 7,   // Night's End
  32649: 2,   // Medallion of Karabor
  32757: 2,   // Blessed Medallion of Karabor
};

// Per-gem shadow resistance (gemId → SR). None observed yet; extend as found.
