...
export const FLASK_IDS = new Set([
  ...
  17637, // Flask of Supreme Power (+150 spell damage) — classic flask, buff name may lack "flask" in WCL
]);
...
export const WEAPON_ENCHANT_IDS = {
  ...
  // 2636, 2639, 2713 — excluded: these are Windfury Totem (Shaman buff, not a player consumable)
};
