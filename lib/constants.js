...
// Includes both WF Totem (applied by Shaman totem to nearby melee) and WF Weapon (Shaman self-enchant).
// 2636, 2639, 2713 = WF Totem effect on non-Shaman melee weapons
// 2643             = WF Weapon (Enhancement Shaman self-enchant, confirmed from live log Bluéthundér/xXjzVNwYFCLBbRn4)
export const WF_ENCHANT_IDS = new Set([2636, 2639, 2643, 2713]);
