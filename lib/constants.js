...
export const FLASK_IDS = new Set([
  ...
  // Shattrath (raid-only BoP) flasks added with BT/Hyjal — buff auras are named
  // "<effect> of Shattrath" (NOT "Flask of …"), so name matching misses them.
  // Confirmed via wowhead tbc spell pages 2026-08-29.
  41608, // Relentless Assault of Shattrath  (Shattrath Flask of Relentless Assault, item 32901)
  41609, // Fortification of Shattrath       (Shattrath Flask of Fortification,      item 32898)
  41610, // Mighty Restoration of Shattrath  (Shattrath Flask of Mighty Restoration, item 32899)
  41611, // Supreme Power of Shattrath       (Shattrath Flask of Supreme Power,      item 32900)
  46837, // Pure Death of Shattrath          (Shattrath Flask of Pure Death,         item 35716)
  46839, // Blinding Light of Shattrath      (Shattrath Flask of Blinding Light,     item 35717)
]);
