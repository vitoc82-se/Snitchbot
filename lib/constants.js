...
export const GUARDIAN_IDS = new Set([
  ...
  17535, // Elixir of the Sages (+18 Int/Spirit)
   9088, // Gift of Arthas (+10 Shadow Resistance, chance to deal shadow damage on hit)
]);
...
export const WEAPON_ENCHANT_IDS = {
  ...
  2636: 'weapon_stone', // confirmed stone (melee DPS, log jXVcA6tbmgqyZfh1) — name unconfirmed
  2639: 'weapon_stone', // confirmed stone (melee DPS, log jXVcA6tbmgqyZfh1) — name unconfirmed
  2713: 'weapon_stone', // confirmed stone (dual-wield off-hand, log jXVcA6tbmgqyZfh1) — name unconfirmed
};
...
export const POTION_CAST_IDS = {
  ...
  41617: 'mana_potion',         // Fel Mana Potion — confirmed
  41618: 'mana_potion',         // Fel Mana Potion (alt ID) — confirmed
  20520: 'mana_potion',         // Dark Rune — confirmed (cast ID = item ID)
