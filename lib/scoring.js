...
export function relevantPotKeys(cls, role) {
  ...
  // All DPS accept any offensive potion — haste, destruction, or mana all count
  const ALL_DPS_POTS = ['destruction_potion', 'haste_potion', 'mana_potion'];
  switch (cls) {
    case 'Warrior': return ALL_DPS_POTS;
    case 'Rogue':   return ALL_DPS_POTS;
    case 'Hunter':  return ALL_DPS_POTS;
    case 'Paladin': return ALL_DPS_POTS; // Retribution
