...
for (const id of SSC)       ITEM_RAID_MAP.set(id, 'Serpentshrine Cavern');
for (const id of TK)        ITEM_RAID_MAP.set(id, 'The Eye');
...
export const RAID_ORDER = ['Karazhan', 'Gruul & Magtheridon', 'Serpentshrine Cavern', 'The Eye'];
