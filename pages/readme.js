...
const ROLE_ROWS = [
  ...
  { role: 'Warrior / Rogue / Hunter DPS',  pots: relevantPotKeys('Warrior', 'dps') },
...
const ELIXIRS = [
  ...
  { name: 'Elixir of Demonslaying',       type: 'Battle',   id: 11406, note: '+265 AP vs demons — relevant in BT/Hyjal' },
  { name: 'Elixir of Ironskin',           type: 'Guardian', id: 39628 },
  { name: 'Elixir of Major Fortitude',    type: 'Guardian', id: 39625, note: '+250 max HP, +10 HP/5s' },
